  ...
  return (
    <div className="landing_body">
      ...
      <div className="landing_window">
        <div className="window_left">
          ACA COMIENZA suscipit, wisi nec facilisis facilisis, est dui fermentum
          leo, quis tempor ligula erat quis odio. Nunc porta vulputate tellus.
